...
total_data = pd.read_csv(path + "total_data.csv",index_col='Unnamed: 0')
vegetal_data = pd.read_csv(path + "vegetal_data.csv",index_col='Unnamed: 0')
grains_data = pd.read_csv(path + "grains_data.csv",index_col='Unnamed: 0')
dairy_data = pd.read_csv(path + "dairy_data.csv",index_col='Unnamed: 0')
meat_data = pd.read_csv(path + "meat_data.csv",index_col='Unnamed: 0')
seafood_data = pd.read_csv(path + "seafood_data.csv",index_col='Unnamed: 0')
oils_data = pd.read_csv(path + "oils_data.csv",index_col='Unnamed: 0')
fish_data = pd.read_csv(path + "fish_data.csv",index_col='Unnamed: 0')
fruits_data = pd.read_csv(path + "fruits_data.csv",index_col='Unnamed: 0')
